		...
		<div className="super__feature mt-5 overflow-hidden">
			<div>
				...
				>
					...
					<div className="flex flex-col w-full">
						<div className=" flex flex-row justify-between ">
							<div className='flex flex-row'>
								<img src={user_pic} className='border border-gray-200 shadow-md rounded-lg p-2 w-[55px] h-[55px] mx-6 mt-1 text-xl sm:mx-[95px] md:mx-[95px] lg:mx-[95px]' alt=''/>
								<div className='flex flex-col mt-1'>
									<h2 className="-mx-4 sm:mx-[95px] md:mx-[95px] lg:mx-[93px]">
										{greeting},
									</h2>
									<h3 className="flex -mx-4 text-2xl sm:mx-[93px]  lg:mx-[92px] ">
										{/* <img src={user_pic} className='w-[35px] h-[35px] mr-4' alt=''/> */}
										{first_name}
									</h3>
								</div>
							</div>
							...
							{notifications > 0 && (
								<div 
									className="btn absolute top-1 left-[50%] bg-[#ff0000] rounded-full h-4 w-4 flex items-center justify-center text-xs text-white"
								...
								/>
								{showDropdown && (
									<div className="absolute top-10 right-0 bg-white  rounded-lg shadow-lg p-4 w-60">
						...
						{user.role != 1 && (
							<div>
							<h4 className="hidden mx-5 my-2 text-2xl mt-8 sm:mx-[93px]  lg:block mx-[91px]">
					...
					<div className=" flex flex-col w-full mx-0 sm:w-full md:w-full lg:w-1/5 mr-[105px] mb-2">
					{user.role != 1 && (
						...
						{/* <div className=" flex lg:flex-col sm:flex flex-col md:w-full m-3  text-[#ddd] items-center bg-[#582066] rounded-lg p-5"> */}
							...
							<div className='flex flex-row'>
								...
								<h3 className="text-2xl mb-2 font-semibold text-[#2e2b43]">
									...
									<div className='flex flex-row text-gray-800 pt-3 pb-3'>
											<FiHash size={16}/><FiHash size={16}/><FiHash size={16}/><FiHash size={16}/>
									</div>
							...
							<button
								type="button"
								className='btn1 btn-effect-4 flex bg-[#ddd] rounded-md text-gray-800 border border-[#722984] px-6 py-1 items-center mb-2'
								onClick={topup}
							>
				...
				{!user.role && wallet['bank'] ===null && (
					<div>
					<div className='flex flex-row bg-gray-100 mx-[5.8%] sm:mx-[95px]  md:mx-3  lg:mx-[92px] rounded-lg shadow-md mb-8'>
						<div className=''>
							<button
							 onClick={generateVirtual}
							 className='bg-gray-800 p-2 m-3 rounded-md text-[#ddd] shadow-md'>Generate Virtual Account</button>
						</div>
						
						<div >
							<div className="marquee mt-5">
								<p className='mt-6 lg:mt-0'>In compliance with <span className='text-bold'>CBN regulations</span>, we wish to notify you that we will require you to provide your <span className='text-bold'>NIN</span> to generate a virtual account.</p>
							</div>
						</div>
