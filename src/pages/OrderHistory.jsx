...
const OrderHistory = () => {
  const [orders, setOrders] = useState([
    {
      ...
      deliveryAddress: "15 Nuhu Aliyu, GRA, Barnawa",
      items: [
    ...
    },
    {
      ...
      deliveryAddress: "6 Botswana Ave, Barnawa",
      items: [
  ...
  return (
    <div className="p-3 md:p-6 bg-white shadow-lg rounded-lg">
      <h2 className="text-2xl  text-gray-800 mb-6">Order History</h2>
      <p className="text-gray-600 mb-4">History of completed orders.</p>
