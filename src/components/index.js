...
export { default as VendorLogin } from './login/VendorLogin';
export { default as Signup } from './signup/Signup';
export { default as VendorSignup } from './signup/VendorSignup';
...
export { default as Groceries } from './dashboard/Groceries';
